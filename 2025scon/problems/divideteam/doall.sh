...
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 1" "tests/09" 9
echo "Generating test #10"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 2" "tests/10" 10
echo "Generating test #11"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 3" "tests/11" 11
echo "Generating test #12"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 4" "tests/12" 12
echo "Generating test #13"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 5" "tests/13" 13
echo "Generating test #14"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 6" "tests/14" 14
echo "Generating test #15"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 7" "tests/15" 15
echo "Generating test #16"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 8" "tests/16" 16
echo "Generating test #17"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 9" "tests/17" 17
echo "Generating test #18"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe 10" "tests/18" 18
echo "Generating test #19"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 11" "tests/19" 19
echo "Generating test #20"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 12" "tests/20" 20
echo "Generating test #21"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 13" "tests/21" 21
echo "Generating test #22"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 14" "tests/22" 22
echo "Generating test #23"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 15" "tests/23" 23
echo "Generating test #24"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 16" "tests/24" 24
echo "Generating test #25"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 17" "tests/25" 25
echo "Generating test #26"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 18" "tests/26" 26
echo "Generating test #27"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 19" "tests/27" 27
echo "Generating test #28"
scripts/gen-input-via-stdout.sh "wine files/rand_gen.exe -mn 500000 20" "tests/28" 28
echo "Generating test #29"
scripts/gen-input-via-stdout.sh "wine files/max_wa_gen.exe 21" "tests/29" 29
echo "Generating test #30"
scripts/gen-input-via-stdout.sh "wine files/max_wa_gen.exe 22" "tests/30" 30
echo "Generating test #31"
scripts/gen-input-via-stdout.sh "wine files/max_wa_gen.exe 23" "tests/31" 31
echo "Generating test #32"
scripts/gen-input-via-stdout.sh "wine files/one_round_gen.exe 24" "tests/32" 32
echo "Generating test #33"
scripts/gen-input-via-stdout.sh "wine files/one_round_gen.exe 25" "tests/33" 33
echo "Generating test #34"
scripts/gen-input-via-stdout.sh "wine files/one_round_gen.exe 26" "tests/34" 34
echo "Generating test #35"
scripts/gen-input-via-stdout.sh "wine files/one_round_gen.exe -one 27" "tests/35" 35
echo "Generating test #36"
scripts/gen-input-via-stdout.sh "wine files/one_round_gen.exe -one 28" "tests/36" 36
echo "Generating test #37"
scripts/gen-input-via-stdout.sh "wine files/one_round_gen.exe -one 29" "tests/37" 37
echo "Generating test #38"
scripts/gen-input-via-stdout.sh "wine files/limit_gen.exe" "tests/38" 38
echo ""
