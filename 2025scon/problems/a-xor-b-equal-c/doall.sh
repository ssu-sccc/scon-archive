...
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 1" "tests/07" 7
echo "Generating test #8"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 2" "tests/08" 8
echo "Generating test #9"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 3" "tests/09" 9
echo "Generating test #10"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 4" "tests/10" 10
echo "Generating test #11"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 5" "tests/11" 11
echo "Generating test #12"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 6" "tests/12" 12
echo "Generating test #13"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 7" "tests/13" 13
echo "Generating test #14"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 8" "tests/14" 14
echo "Generating test #15"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 9" "tests/15" 15
echo "Generating test #16"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe 10" "tests/16" 16
echo "Generating test #17"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 11" "tests/17" 17
echo "Generating test #18"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 12" "tests/18" 18
echo "Generating test #19"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 13" "tests/19" 19
echo "Generating test #20"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 14" "tests/20" 20
echo "Generating test #21"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 15" "tests/21" 21
echo "Generating test #22"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 16" "tests/22" 22
echo "Generating test #23"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 17" "tests/23" 23
echo "Generating test #24"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 18" "tests/24" 24
echo "Generating test #25"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 19" "tests/25" 25
echo "Generating test #26"
scripts/gen-input-via-stdout.sh "wine files/randomGen.exe -mx 500 20" "tests/26" 26
echo "Generating test #28"
scripts/gen-input-via-stdout.sh "wine files/gen_a_gt_2b.exe 21" "tests/28" 28
echo "Generating test #29"
scripts/gen-input-via-stdout.sh "wine files/gen_a_gt_2b.exe 22" "tests/29" 29
echo "Generating test #30"
scripts/gen-input-via-stdout.sh "wine files/gen-a-odd.exe 23" "tests/30" 30
echo "Generating test #31"
scripts/gen-input-via-stdout.sh "wine files/gen-a-odd.exe 24" "tests/31" 31
echo ""
