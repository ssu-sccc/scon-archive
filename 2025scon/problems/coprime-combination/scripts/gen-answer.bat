...
files\val_coprime.exe --testset "%~3" --group "%~4" < %1
if errorlevel 1 pause 0
java.exe -Xmx512M -Xss64M -DONLINE_JUDGE=true -Duser.language=en -Duser.region=US -Duser.variant=US -jar solutions\coprime_AC_java.jar < %1 > output.txt
if errorlevel 1 pause 0
