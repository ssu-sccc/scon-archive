...
echo Validator comment: 1>> validator-tests.log
files\val.exe < files\tests\validator-tests\05 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\val.exe < files\tests\validator-tests\06 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\val.exe < files\tests\validator-tests\07 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\val.exe < files\tests\validator-tests\08 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\val.exe < files\tests\validator-tests\09 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
