...
echo "Validator comment:" 1>> validator-tests.log
wine files/val.exe < files/tests/validator-tests/05 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
    echo "Validator returned zero exit code for a invalid test" 1>> validator-tests.log
    echo "Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment"
    read
...
echo "Validator comment:" 1>> validator-tests.log
wine files/val.exe < files/tests/validator-tests/06 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
    echo "Validator returned zero exit code for a invalid test" 1>> validator-tests.log
    echo "Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment"
    read
...
echo "Validator comment:" 1>> validator-tests.log
wine files/val.exe < files/tests/validator-tests/07 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
    echo "Validator returned zero exit code for a invalid test" 1>> validator-tests.log
    echo "Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment"
    read
...
echo "Validator comment:" 1>> validator-tests.log
wine files/val.exe < files/tests/validator-tests/08 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
    echo "Validator returned zero exit code for a invalid test" 1>> validator-tests.log
    echo "Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment"
    read
...
echo "Validator comment:" 1>> validator-tests.log
wine files/val.exe < files/tests/validator-tests/09 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
    echo "Validator returned zero exit code for a invalid test" 1>> validator-tests.log
    echo "Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment"
    read
