...
files\val_station.exe < files\tests\validator-tests\01 2>> validator-tests.log
if not errorlevel 1 (
...
echo Validator comment: 1>> validator-tests.log
files\val_station.exe < files\tests\validator-tests\02 2>> validator-tests.log
if not errorlevel 1 (
    echo Validator returned zero exit code for a invalid test 1>> validator-tests.log
    echo Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment
    pause 0
...
echo Validator comment: 1>> validator-tests.log
files\val_station.exe < files\tests\validator-tests\03 2>> validator-tests.log
if errorlevel 1 (
