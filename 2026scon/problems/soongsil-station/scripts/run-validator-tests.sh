...
wine files/val_station.exe < files/tests/validator-tests/01 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
...
echo "Validator comment:" 1>> validator-tests.log
wine files/val_station.exe < files/tests/validator-tests/02 2>> validator-tests.log
if [ "$?" -eq "0" ]; then
    echo "Validator returned zero exit code for a invalid test" 1>> validator-tests.log
    echo "Validator returned zero exit code for a invalid test. See validator-tests.log for validator comment"
    read
...
echo "Validator comment:" 1>> validator-tests.log
wine files/val_station.exe < files/tests/validator-tests/03 2>> validator-tests.log
if [ "$?" -ne "0" ]; then
