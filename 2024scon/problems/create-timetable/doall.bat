...
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=1""" "tests\22" 22
echo Generating test #23
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=2""" "tests\23" 23
echo Generating test #24
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=3""" "tests\24" 24
echo Generating test #25
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=4""" "tests\25" 25
echo Generating test #26
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=5""" "tests\26" 26
echo Generating test #27
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=6""" "tests\27" 27
echo Generating test #28
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=7""" "tests\28" 28
echo Generating test #29
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=8""" "tests\29" 29
echo Generating test #30
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=9""" "tests\30" 30
echo Generating test #31
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=10""" "tests\31" 31
echo Generating test #32
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=11""" "tests\32" 32
echo Generating test #33
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=12""" "tests\33" 33
echo Generating test #34
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=13""" "tests\34" 34
echo Generating test #35
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=14""" "tests\35" 35
echo Generating test #36
call scripts\gen-input-via-stdout.bat "files\gen_kill.exe ""-cnt=15""" "tests\36" 36
echo.
