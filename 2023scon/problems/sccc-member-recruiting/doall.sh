...
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 1" "tests/12" 12
echo "Generating test #13"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 2" "tests/13" 13
echo "Generating test #14"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 3" "tests/14" 14
echo "Generating test #15"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 4" "tests/15" 15
echo "Generating test #16"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 5" "tests/16" 16
echo "Generating test #17"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 6" "tests/17" 17
echo "Generating test #18"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 7" "tests/18" 18
echo "Generating test #19"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 8" "tests/19" 19
echo "Generating test #20"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 9" "tests/20" 20
echo "Generating test #21"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=15 10" "tests/21" 21
echo "Generating test #22"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=15" "tests/22" 22
echo "Generating test #32"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd.exe -n=15 -k=1 -x=15" "tests/32" 32
echo "Generating test #37"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=1" "tests/37" 37
echo "Generating test #38"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=2" "tests/38" 38
echo "Generating test #39"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=3" "tests/39" 39
echo "Generating test #40"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=4" "tests/40" 40
echo "Generating test #41"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=5" "tests/41" 41
echo "Generating test #42"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=6" "tests/42" 42
echo "Generating test #43"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=7" "tests/43" 43
echo "Generating test #44"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=8" "tests/44" 44
echo "Generating test #45"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=9" "tests/45" 45
echo "Generating test #46"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=10" "tests/46" 46
echo "Generating test #47"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=11" "tests/47" 47
echo "Generating test #48"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=12" "tests/48" 48
echo "Generating test #49"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=13" "tests/49" 49
echo "Generating test #50"
scripts/gen-input-via-stdout.sh "wine files/gen_rnd_dense.exe -n=15 -k=14" "tests/50" 50
echo ""
